...
export const SAVED_JOBS_API_END_POINT = "http://localhost:3000/api/v1/user/saved-jobs";
export const APPLIED_JOBS_API_END_POINT = "http://localhost:3000/api/v1/application/get";